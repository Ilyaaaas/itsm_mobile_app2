...
import {Text, View, AsyncStorage, ImageBackground, KeyboardAvoidingView, Platform} from 'react-native';
...
export class Login extends React.Component {
  ...
  onLogin = async () => {
    await this._getTokenPush();
    console.log(this.state.pushToken+' hello');
    ...
    if (username && password) {
      try {
        ...
        const response = await fetch(API_URL, {
          ...
          body: `login=${username}&password=${password}&pushtoken=${this.state.pushToken}`, //JSON.stringify({'login': username, 'password': password}),
        });
